...
class FirestoreService {
  ...
  CollectionReference<ColorModel> getProductColorsRef(String productId) =>
      _firestore.collection('products/$productId/color').withConverter<ColorModel>(
          fromFirestore: (snapshot, _) =>
              ColorModel.fromJson(snapshot.data()!),
          toFirestore: (colorModel, _) => colorModel.toJson());

  CollectionReference<Varient> getProductVarientsRef(String productId) =>
      _firestore.collection('products/$productId/varient').withConverter<Varient>(
          fromFirestore: (snapshot, _) =>
